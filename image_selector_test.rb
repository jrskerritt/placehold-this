...
class ImageSelectorTest < Test::Unit::TestCase
  ...
  def test_select_should_return_nil_when_there_are_only_images_with_smaller_dimensions
    family = Family.new('test')
    family.add_image('i1.jpg', 'images/i1.jpg', 299, 99)
    family.add_image('i2.jpg', 'images/i2.jpg', 300, 99)
    family.add_image('i3.jpg', 'images/i3.jpg', 299, 100)
  ...
  def test_select_should_return_an_exact_match_if_one_exists
    family = Family.new('test')
    family.add_image('i1.jpg', 'images/i1.jpg', 400, 250)
  ...
  def test_select_should_return_a_larger_image_closest_in_size_to_the_requested_dimensions
    family = Family.new('test')
    family.add_image('i1.jpg', 'images/i1.jpg', 600, 400)
    family.add_image('i2.jpg', 'images/i2.jpg', 450, 300)
    family.add_image('i3.jpg', 'images/i3.jpg', 500, 200)
    family.add_image('i4.jpg', 'images/i4.jpg', 450, 200) # should be this one
